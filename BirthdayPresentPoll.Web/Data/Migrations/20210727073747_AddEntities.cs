        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CelebrantId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Polls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Polls_AspNetUsers_CelebrantId",
                        column: x => x.CelebrantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Polls_AspNetUsers_InitiatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Votes_Presents_PresentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Polls_CelebrantId",
                table: "Polls",
                column: "CelebrantId");

            migrationBuilder.CreateIndex(
                name: "IX_Polls_InitiatorId",
                table: "Polls",
                column: "InitiatorId");
